...
namespace CoreMVC_Exam.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(20, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.", MinimumLength = 11)]
            [Display(Name = "Phone")]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                   ...
                   await _userManager.UpdateAsync(user); */
                     ...
                     // добавление роли и пользователя в эту роль
                     bool roleExists = await _roleManager.RoleExistsAsync("Client");
                   ...
                   Claim claim = new Claim("Position", "Client");
                   await _userManager.AddClaimAsync(user, claim);
                   await _userManager.UpdateAsync(user); 
                    ...
                    _context.ClientOrders.Add(new ClientOrder { IdPassport = Input.Id, IdUser = userId });
                    _context.SaveChanges();
